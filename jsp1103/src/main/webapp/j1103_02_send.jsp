...
<html>
	...
	<%
		...
		String name = URLEncoder.encode(request.getParameter("name")); //parameter로 할때만 이렇게 해준다.
		//out.println("주민번호 :"+jumin+"<br>");
		//880101-1111111 2023-1988=35
		//030101-4111111 2023-2002=20
		...
		//주민번호 첫번째 2자리 가져옴.
		String ju2 = jumin.substring(0,2); //0부터 2의 앞에 숫자까지.
		int age=0, ju_num=0;
		if(ju1==1 || ju1==2){
